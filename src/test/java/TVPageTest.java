...
public class TVPageTest extends BaseTest{
    ...
    public void sectionTMonTVTest(){
        ...
        //System.out.println(elements.getTextFromElementBy(By.xpath("//div[@id='group-9501']//following-sibling::div/a/div/label")));
    ...
    public void compareTv(){
        ...
        //assertTrue(listOfCompare.size()==2);
    ...
    public void fromCheapToExpensiveTVTest(){
        ...
        System.out.println(elements.getTextFromElementBy(By.xpath("//div[@data-id='3643']/following-sibling::div/div[2]/div/div/div[2]")));
